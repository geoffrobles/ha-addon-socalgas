...
# SoCalGas Usage Importer for Home Assistant

This Home Assistant add-on logs into your SoCalGas account, retrieves your current usage information, and publishes the results to MQTT every 6 hours.
